export default {
  ...
  status: 'Status',
  deletes: 'Are you sure you want to delete this goods?',
  select: 'Select goods',
  prod: 'Product',
  ...
  merAddProdTime: 'Merchant add goods time',
  ...
  addNew: 'Add new',
  singleProductBar: ' Single goods barcode',
  noBarcode: 'If there is no barcode, the system will automatically generate it',
  usedToQuickItem: 'Used to quickly identify the single goods',
  itemName: 'Single goods name',
  singleProdPic: 'Single goods picture',
  singleProdSpe: 'Single goods specification',
  singleProdClas: 'Single goods classification',
  singleProdUnit: ' Single goods unit',
  singleProdInve: 'Single goods inventory',
  supplier: 'Supplier',
  chooseSupplier: 'Select supplier',
  itemNameCanEmpty: 'Single goods name cannot be empty',
  ...
  goodsSpecifi: 'Goods specification',
  ...
  chooSingPro: 'Choose single goods'
}
