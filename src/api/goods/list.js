...
export function page(pageParam) {
  return request({
    url: '/xxw_shop_search/b/search/page',
    method: 'get',
    params: pageParam
  })
}
...
export function updateProdStatus(data) {
  return request({
    url: '/xxw_shop_goods/admin/spu/prod_status',
    method: 'put',
    data
  })
}
...
export function updatePartProdStatus(data) {
  return request({
    url: '/xxw_shop_goods/admin/spu/update_spu_data',
    method: 'put',
    data
  })
}
...
export function rereapplyOnlineById(data) {
  return request({
    url: '/xxw_shop_goods/admin/goods_offline_handle_event/audit_apply',
    method: 'POST',
    data
  })
}
