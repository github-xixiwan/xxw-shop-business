<template>
  <el-dialog :title="dataForm.hotSearchId? $t('table.edit'): $t('table.create')" :visible.sync="visible">
    <el-form ref="dataForm" :rules="rules" :model="dataForm" label-position="right" label-width="80px">
      <!-- 热搜标题 -->
      <el-form-item :label="$t('business.hotSearch.title')" prop="title">
        <el-input v-model="dataForm.title" />
      </el-form-item>
      <!-- 内容 -->
      <el-form-item :label="$t('business.hotSearch.content')" prop="content">
        <el-input v-model="dataForm.content" />
      </el-form-item>
      <!-- 顺序 -->
      <el-form-item :label="$t('business.hotSearch.seq')" prop="seq">
        <el-input-number
      ...
      <!-- 状态 0下线 1上线 -->
      <el-form-item :label="$t('business.hotSearch.status')" prop="status">
